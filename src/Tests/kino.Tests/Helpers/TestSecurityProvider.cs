    ...
    public class TestSecurityProvider : ISecurityProvider
    {
        ...
        private IDictionary<MessageIdentifier, Domain> CreateMessageMapping(IEnumerable<Domain> domains)
        {
            ...
            foreach (var domain in domains)
            {
                ...
                {
                    mapping[new MessageIdentifier(new AsyncExceptionMessage().Identity)] = domain;
                    mapping[new MessageIdentifier(new AsyncMessage().Identity)] = domain;
                    mapping[new MessageIdentifier(new LocalMessage().Identity)] = domain;
                    mapping[new MessageIdentifier(new NullMessage().Identity)] = domain;
                    mapping[new MessageIdentifier(new SimpleMessage().Identity)] = domain;
                }
